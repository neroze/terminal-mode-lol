...
// PROMPT_TYPE
	...
	const promptInput = function (terminalObj, message, PROMPT_TYPE, callback) {
	...
	let TerminalConstructor = function (id) {
		if (!terminalBeep) {
			...
			let source = '<source src="http://www.erikosterberg.com/terminaljs/beep.'
...
export default TerminalConstructor;